...
Medication and Visit present a p value < 0.05. Medication increases the risk of experiencing FOG by 0.7 holding other variables fixed, while , visit does the same with an increase of time to FOG by a rate of 0.2 while holding other features fixed. 
