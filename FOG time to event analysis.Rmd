...
plot(fit_Med, 
     ...
     main = "Time to fog is short for subjects under medication")
#abline(v = 22.2, col = "blue")
#abline(v = 28.9, col = "green")
# legend()
```
...
All p.values are greater than 0.05. There is no effect of events type on FOG occurrence.

### visit 
```{r}
(fit_visit <- survfit(Surv(Begin,End, Kinetic) ~ factor(Visit), data = fog))
...
p-value less than  0.05. Having visit to hospital, has an influence on FOG occurrence.   
