...
```{r, echo=FALSE, message=FALSE, results=FALSE, warning=FALSE}
data <- read_csv("/Users/mpaga/Desktop/Data_science/DSTI/Courses/SurvivalAnalysis/Survival_Analysis_Project/data/heart_failure_clinical_records_dataset.csv")
```
...
splots[[1]] <- ggsurvplot(fit.KM1,
                          conf.int=TRUE,
                          pval=TRUE,
           legend.title="EF levels", 
           legend.lab=c("EF <= 30", "30 < EF <= 45", "EF > 45"),
           title="EF levels Survival Curve", xlab = "Day",   
           pval.size=4,
           legend=c(0.15,0.25),
           pval.coord=c(0,0),
            ggtheme = centre,
...
```{r, echo=FALSE, message=FALSE, results=FALSE, warning=FALSE}
splots[[2]] <- ggsurvplot(fit.KM2, 
                          conf.int=TRUE,
                          pval=TRUE,
           legend.title="Blood pressure", 
           legend.lab=c("low", "high"),
           title="High blood pressure Survival Curve", 
           xlab = "Day",ylab = "",
           pval.size=4,
           legend=c(0.15,0.25),
           pval.coord=c(0,0), 
